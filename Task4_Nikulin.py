...
def add_sentence_to_paragraph(marker_for_past='', str_for_input=''):
    if str_for_input == '':
        print("Enter string into function in format 'string'")
    else:
...
if __name__ == '__main__':
    ...
    text_with_new_sentence = add_sentence_to_paragraph('end of this paragraph', text)
    text_with_norm_case = normalize_text(text_with_new_sentence)
